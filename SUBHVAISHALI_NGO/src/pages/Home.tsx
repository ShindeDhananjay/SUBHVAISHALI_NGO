            ...
            >
              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start gap-8 group">
                  ...
                  <div>
                    <h4 className="font-black text-slate-900 text-xl mb-2">Follow Us</h4>
                    <div className="flex gap-4 mt-2">
                      <a href="https://www.instagram.com/subhvaishalifoundation?igsh=MmlnaXpiZ3JpejAx" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:text-brand-700 font-black">Instagram</a>
                      <a href="https://www.linkedin.com/in/subhvaishali-foundation-808a863ba?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:text-brand-700 font-black">LinkedIn</a>
                      <a href="https://x.com/Subhvaishali" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:text-brand-700 font-black">X</a>
                    </div>
                  </div>
                </div>
              </div>
