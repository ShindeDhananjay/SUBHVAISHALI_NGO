        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold">
              ...
              <li><a href="https://www.linkedin.com/in/subhvaishali-foundation-808a863ba?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-brand-200/60 hover:text-brand-400 transition-colors">LinkedIn</a></li>
              <li><a href="https://x.com/Subhvaishali" target="_blank" rel="noopener noreferrer" className="text-brand-200/60 hover:text-brand-400 transition-colors">X (Twitter)</a></li>
            </ul>
          </div>
        </div>
