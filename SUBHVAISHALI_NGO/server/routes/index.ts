...
import { loginAdmin, getDashboardStats, updateCredentials } from "../controllers/adminController.js";
...
import { registerVolunteer, getVolunteers, updateVolunteerStatus, updateVolunteer, deleteVolunteer } from "../controllers/volunteerController.js";
import { recordDonationIntent, getDonations, updateDonation, deleteDonation } from "../controllers/donationController.js";
import { generateCertificate, getCertificates, verifyCertificate, updateCertificate, deleteCertificate } from "../controllers/certificateController.js";
import { getContent, updateContent, updateMultipleContent } from "../controllers/contentController.js";
