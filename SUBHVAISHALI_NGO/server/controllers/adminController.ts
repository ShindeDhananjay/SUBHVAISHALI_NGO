...
export const getDashboardStats = async (req: Request, res: Response) => {
  try {
    const { Volunteer } = await import("../models/Volunteer.ts");
    const { Donation } = await import("../models/Donation.ts");
    const { Event } = await import("../models/Event.ts");
    const { Certificate } = await import("../models/Certificate.ts");
